...
$m=1;
$d=1;
for ($i=0; $i<=25; $i++) {int(abs($x[$i]));abs($p[$i]);$p[26] -=$p[$i];$x[26] -=$x[$i];}
for ($i=0; $i<=26; $i++) {$m *=$p[$i]**$x[$i]; $d *=fack($x[$i]);}
$result=fack($n)* $m /$d;
return $result;
...
$clean="\t\-\t$mess[17]\t$mess[7]\t$mess[10]\t$mess[3]\t$mess[4]\t$mess[18]\t$mess[19]\t$mess[13]\t$mess[16]\t$mess[2]\t$mess[20]\t$mess[6]\t$mess[15]\t$mess[8]\t$mess[21]\t$mess[24]\t$mess[22]\t$mess[5]\t$mess[12]\t$mess[11]\t$mess[0]\t$mess[1]\t$mess[25]\t$mess[9]\t$mess[23]\t$mess[14]";
...
$beta="\t\-\t$alpha[0]\t$alpha[1]\t$alpha[2]\t$alpha[3]\t$alpha[4]\t$alpha[5]\t$alpha[6]\t$alpha[7]\t$alpha[8]\t$alpha[9]\t$alpha[10]\t$alpha[11]\t$alpha[12]\t$alpha[13]\t$alpha[14]\t$alpha[15]\t$alpha[16]\t$alpha[17]\t$alpha[18]\t$alpha[19]\t$alpha[20]\t$alpha[21]\t$alpha[22]\t$alpha[23]\t$alpha[24]\t$alpha[25]\t";
...
$plus=$banana[8]+$banana[11]+$banana[18];

$minus=$banana[3]+$banana[4];
...
my $residue = $_[0]; if (($residue eq "M") || ($residue eq "W")) {$p=1;} elsif ($residue eq "I") {$p=0.33;} if (($residue eq "A") || ($residue eq "G") || ($residue eq "P") || ($residue eq "T") || ($residue eq "V")) {$p=0.25;} if (($residue eq "R") || ($residue eq "L") || ($residue eq "S")) {$p=0.15;} else {$p=0.5;} return $p;
}
