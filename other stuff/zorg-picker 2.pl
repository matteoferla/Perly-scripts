...
@Todo=qw(Fno Pmo Sth Tra Msi Oih Sul Hth Gau Emi Psp Lar Nma Mse Asa Iho Lca Hbu Sma Tpe Mbo Mst Mma Abo Msm);	
#Aae Aca Afu Ala Ape Asp Atu Bsu Cac Cau Cje Cpn Csa Csy Dra Eco Fnu Gth Hbs homo Hwa Kcr Mac Mae Mbu Mja Mka Mpu Mru Mth Mtu Nap Neq Nos Pab Pae Par Pfu Pho Pin Pmu Pox Pya Rpr Rso Rxy Sau Sce Sso Sty Syn Tac Taq Tga Tma Tpa Tth Tvo Uur Fno Pmo Sth Tra Msi Oih Sul Hth Gau Emi Psp Lar Nma Mse Asa Iho Lca Hbu Sma Tpe Mbo Mst Mma Abo Msm 
##################################
...
foreach $Phenix (@Todo) {
	...
	if ($disable !~ m/X/msg) {
		...
		print "There are ". ($match+$blamatch+$defmatch+$lettermatch)." matched and ".$missing." unmatched genes out of $genenumber (".int(($match+$blamatch+$defmatch+$lettermatch)/$genenumber*100+0.5)."\% done: ".int($match/($match+$blamatch+$defmatch+$lettermatch)*100+0.5)."% by ID, ".int($blamatch/($match+$blamatch+$defmatch+$lettermatch)*100+0.5)."% by blatter, ".int($defmatch/($match+$blamatch+$defmatch+$lettermatch)*100)."% by definition and ".int($lettermatch/($match+$blamatch+$defmatch+$lettermatch)*100)."% by definition)\n";
