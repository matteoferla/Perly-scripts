...
if ($choice =~ m/1/msgi) {
	...
	print "b\:\tthermophile composition --- To do\n";
	print "c\:\tEqual\n";
	...
	elsif ($subchoice=~ m/b/msgi) {$preset[0]="E.coli composition"; @aim=qw(0.094979205 0.054762039 0.039295849 0.051377411 0.011528026 0.044228438 0.057407375 0.073685219 0.022536085 0.059915446 0.106453518 0.043765169 0.028084876 0.038805723 0.044209042 0.057755759 0.053796707 0.015220008 0.028365374 0.070635547 0.003193184); goto SPHINX;}
	...
	if ($subchoice=~ m/a/msgi) {$preset[1]="all equal"; @aim=qw(0.094979205 0.054762039 0.039295849 0.051377411 0.011528026 0.044228438 0.057407375 0.073685219 0.022536085 0.059915446 0.106453518 0.043765169 0.028084876 0.038805723 0.044209042 0.057755759 0.053796707 0.015220008 0.028365374 0.070635547 0.003193184); goto SPHINX;}
		...
		print "Lettercode of amino acid...(anything else for stop codons) "; my $ssc=<>; chomp $ssc; $ssc=~ s/\W//msgi; $ssc=chr($ssc)-65;
...
print ("\tA\tT\tC\tG\n");
print ("\t".(int(100*$climber[0])/100)."\t".(int(100*$climber[1])/100)."\t".(int(100*$climber[2])/100)."\t".(int(100*$climber[3])/100)."\n");
